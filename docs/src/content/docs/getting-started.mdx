...
description: Learn how to use the Starlight Vintage theme in your documentation.
---
...
1. The Starlight Vintage theme is a Starlight [plugin](https://starlight.astro.build/reference/plugins/) that you can install using your favorite package manager:

   <PackageManagers pkg="starlight-theme-vintage" />
